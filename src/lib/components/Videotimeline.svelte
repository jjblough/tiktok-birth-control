  ...
  <div class="vt-phone-col">
    <div class="vt-phone">
      ...
      <div class="vt-controls">
        ...
        <button class="vt-btn vt-btn-mute" on:click={toggleMute} aria-label={muted ? 'Unmute' : 'Mute'}>
          {#if muted}
            <!-- Muted icon -->
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
...
<style>
  ...
  .vt-chapter--past .vt-detail { opacity: 0.5; color: #e07a5f; }
  ...
  .vt-chapter--active .vt-detail { opacity: 1; color: #e07a5f; }
